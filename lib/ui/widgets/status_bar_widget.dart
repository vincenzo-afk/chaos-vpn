...
/// Row of effect indicator chips showing which effects are active.
class StatusBarWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final effects = [
      _EffectChip(label: 'Gain', active: settings.gainEnabled, icon: Icons.volume_up),
      ...
      _EffectChip(label: 'Fuzz', active: settings.softClipEnabled, icon: Icons.waves),
      ...
      _EffectChip(label: 'Radio', active: settings.bandpassEnabled, icon: Icons.radio),
      _EffectChip(label: 'Reverb', active: settings.reverbEnabled, icon: Icons.meeting_room),
      _EffectChip(label: 'HardClip', active: settings.hardClipEnabled, icon: Icons.flash_on),
    ];
